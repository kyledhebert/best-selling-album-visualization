(function(albviz) {
    ...
    var chartContainer = d3.select('#sales-bar');
    ...
    // append the SVG to the chart containes
    ...
    albviz.updateSalesBarChart = function(data) {
        ...
        yLabel.text("Album Sales in Millions");
        ...
        bars
            .classed('active', function(d) {
                return d.genre === albviz.activeGenere;
            })
            .transition().duration(albviz.TRANS_DURATION)
            .attr("x", function(d) {
